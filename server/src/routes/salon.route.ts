...
import { AddSalonAddress, registerSalon,uploadProfileImages,uploadGalleryImgs, addContact, addSocialLinks, salonLogin, followerList, UpdateShopStatus, addRecentlyVisitedShop } from "../controller/salon.controller";
...
router.route("/shop/addRecentlyVisitedSalon/:salonId").post(VerifyToken,addRecentlyVisitedShop);
